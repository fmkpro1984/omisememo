...
/**
 Base class for all Omisememo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Omisememo view hierarchy (such as wrapped iOS UIViews) was touched.
