 ...
 * Copyright (c) 2009-2011 by Omisememo, Inc. All Rights Reserved.
...
//@interface OmisememoObject : NSObject
//@end

@interface OmisememoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OmisememoObject class]])
		{
			for (NSString *key in [[(OmisememoObject*)o modules] allKeys])
			{
