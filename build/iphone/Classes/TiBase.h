...
// in simulator we redefine to format for Omisememo Developer console
...
{\
	NSString * exceptionName = [@"org.omisememo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.omisememo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIOmisememoNativeItemNone = -1, 
	UIOmisememoNativeItemSpinner = -2,
	UIOmisememoNativeItemProgressBar = -3,
	
	UIOmisememoNativeItemSlider = -4,
	UIOmisememoNativeItemSwitch = -5,
	UIOmisememoNativeItemMultiButton = -6,
	UIOmisememoNativeItemSegmented = -7,
	
	UIOmisememoNativeItemTextView = -8,
	UIOmisememoNativeItemTextField = -9,
	UIOmisememoNativeItemSearchBar = -10,
	
	UIOmisememoNativeItemPicker = -11,
	UIOmisememoNativeItemDatePicker = -12,
	
	UIOmisememoNativeItemInfoLight = -13,
	UIOmisememoNativeItemInfoDark = -14,
	
	UIOmisememoNativeItemDisclosure = -15,
	
	UIOmisememoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Omisememo instances of
