...
@interface OmisememoObject : KrollCoverageObject {
#else
@interface OmisememoObject : KrollObject {
#endif
@private
...
extern NSString * Omisememo$ModuleRequireFormat;
